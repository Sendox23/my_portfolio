        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            <p>
              ...
              level.
              <hr/> I take pride in my ability to write clean, organized code
              ...
              to delivering results that exceed clients' expectations.
              <hr/> In my free time, I enjoy staying active and engaged through
              a variety of interests and hobbies. I am a fan of both UFC and
              football, and I enjoy playing pool and video games, working out,
              playing chess, cooking, and spending time with my dog. These
              pursuits help me to maintain a healthy work-life balance and bring
              a fresh perspective to my work as a front-end web developer.
              <hr/>Let's work together to bring your ideas to life on the web.
              I am confident in my ability to deliver results that meet your
              needs and exceed your expectations.
            </p>
            <a className={classes.resume} href={resume}>
              My resume (pdf)
            </a>
          </div>
          <div className="col-lg-3"></div>
